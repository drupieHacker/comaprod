...
$sql="update view_previa set title='$title',date='$date',description='$description',imagen='$archivo'  
where nam='$nam'";
...
';
 echo '<a href="consulta.php" style="background:#feca57;padding:10px;color:#fafafa;text-decoration:none;">Regresar</a>';
?>
